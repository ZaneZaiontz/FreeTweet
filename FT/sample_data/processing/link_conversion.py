...
SPOILER_GAP: int = 5 # default value of 5
TWIT_PROXY: str = "fx"
...
def fix_links(user_input) -> str:
    ...
    int link_gap: Position in the string to add TWIT_PROXY to, should be placed right after 'https://'
...
def add_spoiler(links) -> list:
    """Add a discord spoiler tag to the given links"""
    new_links = []
